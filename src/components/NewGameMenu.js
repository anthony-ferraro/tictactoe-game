...
const NewGameMenu = () => {
  ...
  const [playerMarker, setPlayerMarker] = useState(context.playerMarker);
  const navigate = useNavigate();

  const togglePlayerMarker = (marker) => {
    ...
    <div className="new-game-menu">
      ...
      <div className="grey-border mark-select">
        ...
        <div className="mark-buttons-wrapper">
            <button onClick={() => togglePlayerMarker('x')} className={playerMarker==='o' ? "bg-dark-navy" : "bg-silver"}>
            ...
            <button onClick={() => togglePlayerMarker('o')} className={playerMarker==='o' ? "bg-silver" : "bg-dark-navy"}>
